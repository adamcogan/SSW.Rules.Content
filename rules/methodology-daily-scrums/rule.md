...
### Tip 3: Create an Recurring Appointment + Keep a schedule of the Daily Scrum times on a wall
...
:::
::: good
Figure: Good example - Clear details of the top couple of things you aim to do that day. Send at the start of your day.  (The <mark>yellow</mark> is highlighting specifics missed from the bad example.)
